  ...
  d2)
    case $1 in
      sum)
        ...
        result=${result#\"}
        result=${result%\"}
        result=${result//\`\`\`html/\`\`\`python${COLOR_DARK_GREY}}
        result=${result//\`\`\`html/\`\`\`cpp${COLOR_RED}}
        result=${result//\`\`\`html/\`\`\`java${COLOR_LIGHT_RED}}
        result=${result//\`\`\`html/\`\`\`csharp${COLOR_GREEN}}
        result=${result//\`\`\`html/\`\`\`rust${COLOR_LIGHT_GREEN}}
        result=${result//\`\`\`html/\`\`\`go${COLOR_BROWN_ORANGE}}
        result=${result//\`\`\`html/\`\`\`swift${COLOR_YELLOW}}
        result=${result//\`\`\`html/\`\`\`typescript${COLOR_LIGHT_BLUE}}
        result=${result//\`\`\`html/\`\`\`kotlin${COLOR_LIGHT_PURPLE}}
        result=${result//\`\`\`html/\`\`\`ruby${COLOR_CYAN}}
        result=${result//\`\`\`html/\`\`\`php${COLOR_LIGHT_CYAN}}
